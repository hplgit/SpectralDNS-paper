...
def cross(a, b, c):
    ...
    return c
\end{python}
\captionof{figure}{Numba implementation of the cross product.}\label{fig:numba}
\end{minipage}
...
\includegraphics[scale=0.44]{figs/weak_scaling_shaheen_numpy_noopt.png}
\label{fig:weak_scaling_shaheen}
}
\subfigure[Python solver optimized with Cython]{
\includegraphics[scale=0.44]{figs/weak_scaling_shaheen_numpy_opt.png}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale=0.44]{figs/strong_scaling_fft_512.png}
...
\begin{figure}[ht!]
\subfigure[Pure Python solver (\texttt{numpy}, \texttt{mpi4py}, \texttt{pyfftw})]{
\includegraphics[scale=0.44]{figs/strong_scaling_shaheen_noopt_512.png}
\label{fig:strong_scaling_shaheen}
}
\subfigure[Python solver optimized with Cython]{
\includegraphics[scale=0.44]{figs/strong_scaling_shaheen_opt_512.png}
